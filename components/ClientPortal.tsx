                         ...
                         <div className="mt-6 flex justify-between items-center non-printable border-t border-public-border pt-4">
                            ...
                            <div className="space-x-2">
                                ...
                                <button type="button" onClick={() => {
                                    // Import and use enhanced print functionality
                                    import('../lib/printStyles').then(({ preparePrintDocument }) => {
                                        preparePrintDocument(viewingDocument.type === 'invoice' ? 'invoice-content' : 'receipt-content');
                                    });
